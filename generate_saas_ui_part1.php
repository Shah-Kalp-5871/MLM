...
$userLayoutDir = $viewsDir . '/layouts';
if (!is_dir($userLayoutDir)) mkdir($userLayoutDir, 0777, true);

// ---------------------------------------------------------
// 1. GENERATE USER LAYOUT (resources/views/layouts/user.blade.php)
// ---------------------------------------------------------
$userLayout = <<<'HTML'
<!DOCTYPE html>
<html lang="en">
...
HTML;
file_put_contents($userLayoutDir . '/user.blade.php', $userLayout);
echo "Layout user.blade.php created.\n";
