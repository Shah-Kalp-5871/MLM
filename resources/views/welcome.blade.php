                ...
                <div class="glass-panel p-10 rounded-[2.5rem] border-white/5 hover:border-purple-500/30 transition-all group relative overflow-hidden">
                    ...
                    <ul class="space-y-4 mb-10">
                        <li class="flex items-center gap-3 text-sm font-medium text-gray-300">
                            <i data-lucide="check" class="w-5 h-5 text-emerald-500"></i> $15 - $17.5 Weekly ROI
                        </li>
                        <li class="flex items-center gap-3 text-sm font-medium text-gray-300">
                    ...
                    <a href="{{ route('register') }}" class="block w-full py-5 rounded-2xl bg-white text-center text-xs font-black text-black uppercase tracking-widest hover:bg-purple-600 hover:text-white transition-all">Start with $500</a>
                </div>
