...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
    <div class="glass-panel p-6 rounded-2xl relative overflow-hidden group border-l-4 border-l-emerald-500">
        ...
        <h3 class="text-2xl font-black text-white">₹{{ number_format($stats['wallet_balance'], 2) }}</h3>
    </div>
    ...
    <div class="glass-panel p-6 rounded-2xl relative overflow-hidden group">
        ...
        <h3 class="text-2xl font-black text-white">₹{{ number_format($stats['weekly_roi'], 2) }}</h3>
    </div>
    ...
    <div class="glass-panel p-6 rounded-2xl relative overflow-hidden group">
        ...
        <h3 class="text-2xl font-black text-white">₹{{ number_format($stats['total_investment'], 2) }}</h3>
    </div>
