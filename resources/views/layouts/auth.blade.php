...
<head>
    ...
    <style>
        body { background-color: var(--bg-deep, #0a0b14); color: var(--text-main, #94a3b8); transition: background-color 0.3s; }
        .glass-panel { background: var(--glass-bg, rgba(255, 255, 255, 0.03)); backdrop-filter: blur(16px); border: 1px solid var(--glass-border, rgba(255, 255, 255, 0.08)); transition: background 0.3s, border-color 0.3s; }
        .auth-input { background: rgba(255, 255, 255, 0.02); border: 1px solid rgba(255, 255, 255, 0.1); color: var(--text-main, white); transition: all 0.3s; }
